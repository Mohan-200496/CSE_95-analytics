...
async def create_test_users():
    try:
        ...
        async with AsyncSession(async_engine) as session:
            # Use a pre-generated bcrypt hash for "test123" (less than 72 bytes)
            ...
            print("3. Test the enhanced job posting workflow with application methods and resume requirements!")
